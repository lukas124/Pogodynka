...
public class PressureGraph extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pressure_graph, container, false);
    ...
    private void getData(JSONObject json) {
        try {
            ...
            yVals.add(new Entry(Math.round(main.getDouble("pressure")), 0));
            yVals.add(new Entry(Math.round(main1.getDouble("pressure")), 1));
            yVals.add(new Entry(Math.round(main2.getDouble("pressure")), 2));

            Log.e("Pressure date graph", yVals.get(0).toString());
            ...
            LineDataSet set1 = new LineDataSet(yVals, "Pressure");
